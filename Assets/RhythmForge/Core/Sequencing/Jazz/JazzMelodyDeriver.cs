    ...
    public sealed class JazzMelodyDeriver : IMelodyDeriver
    {
            ...
            GenreProfile genre)
        {
            ...
            for (int i = 0; i < samples.Count; i++)
            {
                ...
                int durationSteps = Mathf.Clamp(Mathf.RoundToInt(durationBase + (1f - sp.speedVariance) * 1.5f + sizeFactor * 2f - sound.transientSharpness * 1.2f), 1, 6);
                ...
                notes.Add(new MelodyNote
                {
                    ...
                    velocity = MathUtils.RoundTo(Mathf.Clamp(0.38f + curvature * 0.78f + sp.curvatureMean * 0.18f, 0.22f, 0.88f), 2),
